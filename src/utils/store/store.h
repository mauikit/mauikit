...
enum CATEGORY_KEY : uint { WALLPAPERS, IMAGES, COMICS, AUDIO, ART, CLIPS, MOVIES, EBOOKS, NONE };

enum ATTRIBUTE_KEY : uint { PREVIEW_1, PREVIEW_2, PREVIEW_SMALL_1, PREVIEW_SMALL_2, DOWNLOAD_LINK, XDG_TYPE };

static const QHash<STORE::ATTRIBUTE_KEY, QString> ATTRIBUTE = {{STORE::ATTRIBUTE_KEY::PREVIEW_1, QString("previewpic1")},
...
const QStringList WALLPAPERS_LIST = QStringList {"wallpapers",
                                                 "wallpapers",
                                                 "Wallpaper",
                                                 "Wallpapers",
                                                 "Wallpaper 800x600",
...
const QStringList COMICS_LIST = QStringList {"comics", "Comics", "comic", "Comic"};

const QStringList ART_LIST = QStringList {"art", "drawings", "Art", "Wallpapers", "Drawings", "Paintings", "paintings", "Drawings/Paintings"};

const QStringList EBOOKS_LIST = QStringList {"Books",
...
static const QHash<CATEGORY_KEY, QStringList> CATEGORIES = {{CATEGORY_KEY::WALLPAPERS, QStringList() << STORE::WALLPAPERS_LIST},
