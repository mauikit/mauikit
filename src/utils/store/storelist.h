...
public:
    ...
    enum PROVIDER : uint_fast8_t { OPENDESKTOP, KDELOOK, KRITA, OPENDESKTOPCC };
    Q_ENUM(PROVIDER)

    enum SORTBY : uint_fast8_t { RATE = Attica::Provider::SortMode::Rating, DATE = Attica::Provider::SortMode::Newest, LABEL = Attica::Provider::SortMode::Alphabetical, COUNT = Attica::Provider::SortMode::Downloads };
    Q_ENUM(SORTBY)
    ...
    enum ORDER : uint_fast8_t { Newest = Attica::Provider::SortMode::Newest, Alphabetical = Attica::Provider::SortMode::Alphabetical, Rating = Attica::Provider::SortMode::Rating, Downloads = Attica::Provider::SortMode::Downloads };
    Q_ENUM(ORDER)
