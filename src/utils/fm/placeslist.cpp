...
QHash<int, QByteArray> PlacesList::roleNames() const
{
    static QHash<int, QByteArray> names {{Qt::DisplayRole, "name"}, {KFilePlacesModel::UrlRole, "url"}, {KFilePlacesModel::HiddenRole, "hidden"}, {KFilePlacesModel::SetupNeededRole, "setup"}, {Qt::BackgroundRole, "background"}, {Qt::DecorationRole, "icon"}};
